...
if (!class_exists('AddThisFollowButtonsVerticalWidget')) {
    /**
     * WordPress widget class for AddThis Vertical Follow Buttons
     *
     ...
     */
    class AddThisFollowButtonsVerticalWidget extends AddThisWidget
    {
        /**
