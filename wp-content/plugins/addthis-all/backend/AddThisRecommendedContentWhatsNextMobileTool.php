...
if (!class_exists('AddThisRecommendedContentWhatsNextMobileTool')) {
    /**
     * A class with various special configs and functionality for
     * AddThis Recommended Content What's Next Mobile tools
     *
     ...
     */
    class AddThisRecommendedContentWhatsNextMobileTool extends AddThisRecommendedContentToolParent
    {
        public $prettyName = 'What\'s Next Mobile';
