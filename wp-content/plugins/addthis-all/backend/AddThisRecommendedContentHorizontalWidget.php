...
if (!class_exists('AddThisRecommendedContentHorizontalWidget')) {
    /**
     * WordPress widget class for AddThis Horizontal Recommended Content
     *
     ...
     */
    class AddThisRecommendedContentHorizontalWidget extends AddThisWidget
    {
        /**
