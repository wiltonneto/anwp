...
if (!class_exists('AddThisSharingButtonsJumboWidget')) {
    /**
     * WordPress widget class for AddThis Jumbo Counter Sharing Buttons
     *
     ...
     */
    class AddThisSharingButtonsJumboWidget extends AddThisWidget
    {
        /**
