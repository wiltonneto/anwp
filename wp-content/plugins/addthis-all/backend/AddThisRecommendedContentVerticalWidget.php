...
if (!class_exists('AddThisRecommendedContentVerticalWidget')) {
    /**
     * WordPress widget class for AddThis Vertical Recommended Content
     *
     ...
     */
    class AddThisRecommendedContentVerticalWidget extends AddThisWidget
    {
        /**
