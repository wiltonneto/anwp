...
if (!class_exists('AddThisFollowButtonsCustomWidget')) {
    /**
     * WordPress widget class for AddThis Custom Follow Buttons
     *
     ...
     */
    class AddThisFollowButtonsCustomWidget extends AddThisWidget
    {
        /**
