...
if (!class_exists('AddThisSharingButtonsResponsiveWidget')) {
    /**
     * WordPress widget class for AddThis Responsive Sharing Buttons
     *
     ...
     */
    class AddThisSharingButtonsResponsiveWidget extends AddThisWidget
    {
        /**
