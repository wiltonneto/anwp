...
if (!class_exists('AddThisSharingButtonsSquareWidget')) {
    /**
     * WordPress widget class for AddThis Sharing Buttons
     *
     ...
     */
    class AddThisSharingButtonsSquareWidget extends AddThisWidget
    {
        /**
