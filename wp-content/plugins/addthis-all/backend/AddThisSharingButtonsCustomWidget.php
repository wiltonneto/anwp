...
if (!class_exists('AddThisSharingButtonsCustomWidget')) {
    /**
     * WordPress widget class for AddThis Custom Sharing Buttons
     *
     ...
     */
    class AddThisSharingButtonsCustomWidget extends AddThisWidget
    {
        /**
