...
if (!class_exists('AddThisRecommendedContentToasterTool')) {
    /**
     * A class with various special configs and functionality for
     * AddThis Recommended Content Toaster tools
     *
     ...
     */
    class AddThisRecommendedContentToasterTool extends AddThisRecommendedContentToolParent
    {
        public $prettyName = 'Recommended Content Toaster';
