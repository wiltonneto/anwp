...
if (!class_exists('AddThisRecommendedContentDrawerTool')) {
    /**
     * A class with various special configs and functionality for
     * AddThis Recommended Content Drawer tools
     *
     ...
     */
    class AddThisRecommendedContentDrawerTool extends AddThisRecommendedContentToolParent
    {
        public $prettyName = 'Recommended Content Drawer';
