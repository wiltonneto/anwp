...
function phdropabble() {
    jQuery(".drop").remove(), jQuery(".email-drop").each(function() {
...
function phflash(e) {
    jQuery(".modal-container").load(e + " #phsf", function(e) {
        jQuery(".modal-loading").hide(), phdropabble(), pluginhuntbind();
        var t = 1;
        initialiseslick(t)
    })
}
...
function pluginhuntbind() {
    ...
    }), countdownfire(), jQuery(".add_to_cart_inline").bind("click", function(e) {
        e.stopPropagation()
    ...
    jQuery(".comment-submit").unbind("click").bind("click", function() {
        ...
        jQuery(".drop").remove(), jQuery("html").addClass("noscroll"), jQuery(".modal-container").html(""), jQuery("body").addClass("showing-discussion"), jQuery(".modal-overlay").show(), jQuery(".show-post-modal").show(), jQuery(".modal-container").show(), jQuery(".modal-loading").show(), jQuery(".show-post-modal").removeClass("hide"), jQuery(".modal--close").show();
        var e = jQuery(this).attr("data-ph-url");
        phflash(e), jQuery(".ph_popover").hide()
