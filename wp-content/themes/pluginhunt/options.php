...
function optionsframework_options() {
	...
	*/
	...
	$options[] = array(
		...
		'type' => "images",
		'options' => array(
			'index-1' => $imagepath . 'index-1.png',
			'index-2' => $imagepath . 'index-2.png',
		)
	);
	...
	$options[] = array(
		'name' => "Footer Layout Style",
		'desc' => "Choose your footer layout style.",
		'id' => "ph_footer_layout_style",
		'std' => "footer-1",
		'type' => "images",
		'options' => array(
			'index-1' => $imagepath . 'footer-1.png',
		)
	);
	...
	$options[] = array(
		'name' => __( 'Default to Grid Layout', 'pluginhunt' ),
		'desc' => __( 'Default to Grid Layout.', 'pluginhunt' ),
		'id' => 'ph_grid_on',
		'type' => 'checkbox'
	);
...
*/
	...
	$options[] = array(
		'name' => __('Slider', 'pluginhunt'),
		'type' => 'heading'
	);
	
	$options[] = array(
		'name' => __( 'Show Slider.', 'pluginhunt' ),
		'desc' => __( 'Show Slider.', 'pluginhunt' ),
		'id' =>'ph_show_slider',
		'type' => 'checkbox'
	);
