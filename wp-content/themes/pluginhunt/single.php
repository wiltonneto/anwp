			 	...
			 	<div class='post-header-shadow'>
				 	<div class='container-title'>
				 		...
				 		<div class='reddit-wrapper'>
							...
							<a class='get-it' href="<?php echo esc_url($out); ?>" title="<?php the_title_attribute(); ?>" target="_blank" rel="nofollow"><?php echo of_get_option('ph_get_it'); ?></a>
				 		</div>
                                ...
                                <a class="user-image post-detail--footer--meta--user-image" href="#">
                                    <span class="user-image">
                                      ...
                                      <div class="who-by profile-drop">
                                        <a class="drop-target drop-theme-arrows-bounce-dark"><?php echo get_avatar($aid, 40); ?></a>
...
-->
					...
					<div class='section section-sim'>
						<h3 class='h3'><?php _e('similar products','pluginhunt'); ?></h3>
						<p class="post-detail">
						        ...
						        <a rel="external" href="<?php the_permalink()?>">
						          <?php the_post_thumbnail('medium'); ?>
						            <div class='desc-wrap'>
							          ...
							          <?php echo ph_output_voting($post->ID); ?>
						      	    </div>
						        </a>
						    </div>
						    ...
						    <?php
						    	echo "<span>";
						    	_e('No similar products yet.','pluginhunt');
						    	echo "&nbsp;</span>";
						    }
						    $post = $orig_post;
						    wp_reset_query();
